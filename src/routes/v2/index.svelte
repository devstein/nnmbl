...
<section class="snap-y snap-proximity lg:snap-mandatory scroll-auto h-screen overflow-auto">
	<div class="hero bg-neutral-content snap-start lg:snap-center" id="main">
		<div class="hero-content min-h-screen flex flex-col text-center text-neutral mt-12">
			<div class="max-w-lg space-y-6">
				<h1 class="text-5xl font-bold">timing matters</h1>
				<h1 class="text-4xl">
					<span class="font-mono text-primary">nnbml</span> gives timing back to candidates and companies
				</h1>
				<p class="flex-1 mb-2">
					The proliferation of sourcing software has allowed companies to reach a broader set of
					candidates than ever before, yet recruiting is still the number one pain point of growing
					companies. At its core, recruiting is a matching problem, and the modern recruiting stack
					fails to address a key element: <i>timing</i>.
				</p>
				<p class="flex-1 mb-2">not now, maybe later — nnmbl — takes care of timing for you.</p>
			</div>
		...
		>
			<div class="">
				<div class="max-w-xl mb-5">
					<h3 class="text-4xl text-left text-accent py-8">Candidates</h3>
	...
	<div class="hero bg-neutral-content snap-start lg:snap-center" id="companies">
		...
		>
			<div class="">
				<div class="max-w-xl mb-5">
					<h3 class="text-4xl text-left text-secondary py-8">Companies</h3>
